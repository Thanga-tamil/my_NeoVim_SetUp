...
vim.api.nvim_set_keymap('n', 'z', 'i<Space><Space><Space><Space><Space><Space><Space><Space><Esc>', { noremap = true })
...
vim.api.nvim_set_keymap('i', '<Tab>j', '<Esc>', { noremap = true })
...
--visual Block mode
vim.api.nvim_set_keymap('n', '<Leader>vv', '<C-V><Right>', { noremap = true })
